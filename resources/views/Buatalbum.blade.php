...
<body>
    <nav class="fixed top-0 z-20 w-full bg-white shadow-md">
      ...
      <form action="/buat_album" method="POST" enctype='multipart/form-data'>
      <div class="mb-6 mt-28 ml-40 max-w-screen-lg mx-auto">
        @csrf
        <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Judul Album</label>
        <input type="text" name="nama_album" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      </div>
      <div class="mb-6 ml-40 max-w-screen-lg mx-auto">
        ...
        <input type="text" name="deskripsi" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      </div>
