                ...
                <div class="w-2/5  max-[480px]:w-full px-2">
                    ...
                    <h3>Judul</h3>
                       ...
                       <h3 class="mt-4">Deskripsi</h3>
                        <textarea type="text" name="deskripsi" id="" cols="30" rows="10" class="w-full h-36 border-slate-500 rounded-xl"></textarea>
                        @error('deskripsi')
                                <p>{{$message}}</p>
                            @enderror
                            <h3 class="mt-3">
                            ...
                            <select name="album" id="" class="w-full rounded-full">
