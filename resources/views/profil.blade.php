...
<body>
    ...
    <section class="max-w-screen-md mt-36 mx-auto">
            ...
            <div class="w-3/5 max-[480px]:w-full">
                <div class="bg-white rounded-md shadow-md ">
                    <div class="flex flex-col px-4 py-4 ">
                        <h5 class="text-3xl text-center font-hurricane">Profil Anda</h5>
                        <h5>Nama Lengkap</h5>
                        <input type="text" name="nama_lengkap" class="py-1 rounded-md">
                        
                        <h5>Alamat</h5>
                        <input type="text" name="alamat" class="py-1 rounded-md">
 
                        <h5>Bio</h5>
                        <input type="text" name="bio" class="py-1 rounded-md">
