            ...
            <div class="max-[480px]:w-full">
                <div class="bg-white rounded-md shadow-md ">
                    <div class="flex flex-col px-4 py-4 ">
                        <h5 class="text-3xl text-center font-hurricane">Ubah Password Anda</h5>
                        <h5>Password lama</h5>
                        ...
                        <input type="password" name="repeat_password" class="py-1 rounded-md">
                        <button type="submit" class="py-2 mt-4 text-white rounded-md bg-slate-600">Perbaharui</button>
                    </div>
                </div>
            </div>
            </form>
